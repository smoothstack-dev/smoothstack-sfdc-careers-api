...
export const generateApplicationNote = ({
  ...
  const noteObj = {
    ...
    'How would you rank your skills for this type of job? (0 - lowest, 10 - highest)': applicationFields.selfRank,
    ...(applicationFields.physicalRequirements && {
      'Do you meet the physical requirements for this type of job': applicationFields.physicalRequirements,
    }),
    ...(applicationFields.techSelection && { 'Strongest Language': applicationFields.techSelection }),
    ...
    ...(applicationFields.yearsOfExperience && {
      'Years of Experience (Including Personal/Educational Projects)': applicationFields.yearsOfExperience,
    }),
    'Military Status': candidateFields.militaryStatus,
    ...(candidateFields.militaryBranch && { 'Military Branch': candidateFields.militaryBranch }),
  };
